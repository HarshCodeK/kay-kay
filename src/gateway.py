...
<meta name="description" content="OpenAI-compatible gateway. Provider fallback, telemetry, cost tracking. Chapter 1: Connect + Observe.">
...
.pill{display:inline-block;font:11px/1 var(--mono);font-weight:600;padding:4px 10px;border-radius:999px}.pill.ok{background:rgba(76,195,138,.12);color:var(--accent);border:1px solid rgba(76,195,138,.3)}.pill.bad{background:rgba(248,81,73,.1);color:var(--bad);border:1px solid rgba(248,81,73,.3)}
...
<div class="wrap">
  <div class="hero">
    ...
    <p class="lead">Drop-in OpenAI-compatible gateway — change <code>base_url</code> + <code>api_key</code> and get provider fallback, per-call telemetry, and honest cost estimates.</p>
  </div>
